...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://iyaddz.ml/images/Davis.jpg",
caption=f"""**ꔷＤＥＶ ＳＵＯＲＣＥ iyad**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton(
                    "تواصل ◍", url=f"https://t.me/ewnsbot"
                ),
                ],
                [
                    InlineKeyboardButton(
...
async def ahmad(client: Client, message: Message): 
  await message.reply_photo(
    photo="https://iyaddz.ml/images/Davis.jpg",
    caption=f"""**𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗧𝗛𝗘 𝗛𝗘𝗟𝗣 𝗦𝗢𝗨𝗥𝗖𝗘 iyad 𝗠𝗨𝗦𝗜𝗖 ◍**
...
════════ ××× ════════""",
        ...
        [
            [
                InlineKeyboardButton(f"قناة السورس  ◍", url=f"https://t.me/STSP4"),
                ],[
                InlineKeyboardButton(f"◍ اضفني الي قناتك", url=f"https://t.me/ms1tbot?startchannel=true"),
                ],[
                InlineKeyboardButton("◍ أضفني الى مجموعتك", url=f"https://t.me/ms1tbot?startgroup=true"),
                ]
            ]
        ),
    )
